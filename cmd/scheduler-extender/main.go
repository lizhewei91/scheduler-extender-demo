...
import (
	...
	"scheduler-extender-demo/pkg/controller"
	"scheduler-extender-demo/pkg/scheduler"
	"scheduler-extender-demo/pkg/utils/signals"
...
var (
	...
	logLevel   = flag.String("log-level", "0", "log level of scheduler extender serves")
)
